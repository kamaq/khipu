...
public class ProfileDetailFormPresenter implements FormViewListener, Serializable {

  private static final long serialVersionUID = -6117780258826160344L;
  private FormView formView;
  private ProfileDetailFormModel formModel;

  public ProfileDetailFormPresenter(FormView view, ProfileDetailFormModel model, KhipuAppUI app,
