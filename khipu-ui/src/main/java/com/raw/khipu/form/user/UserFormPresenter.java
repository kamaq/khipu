...
public class UserFormPresenter implements FormViewListener, Serializable {

  private static final long serialVersionUID = -6117780258826160344L;
  private FormView formView;
  private UserFormModel formModel;

  public UserFormPresenter(FormView view, UserFormModel model, KhipuAppUI app,
