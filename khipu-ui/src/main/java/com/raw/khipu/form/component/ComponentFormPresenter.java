...
public class ComponentFormPresenter implements FormViewListener, Serializable {

  private static final long serialVersionUID = -6117780258826160344L;
  private FormView formView;
  private ComponentFormModel formModel;

  public ComponentFormPresenter(FormView view, ComponentFormModel model, KhipuAppUI app,
