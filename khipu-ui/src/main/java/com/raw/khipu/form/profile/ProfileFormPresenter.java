...
public class ProfileFormPresenter implements FormViewListener, Serializable {

  private static final long serialVersionUID = -6117780258826160344L;
  private FormView formView;
  private ProfileFormModel formModel;

  public ProfileFormPresenter(FormView view, ProfileFormModel model, KhipuAppUI app,
